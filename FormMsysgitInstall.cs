...
namespace GitForce
{
    public partial class FormMsysgitInstall : Form
    {
        ...
        private void Work()
        {
            labelInfo.Text = "Searching for the latest msysgit installer...";
        ...
        private bool GetTargetFile(out string targetFile)
        {
            try
            {
                WebRequest request = WebRequest.Create("http://code.google.com/p/msysgit/downloads/list?q=full+installer+official+git");
